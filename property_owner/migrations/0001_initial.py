    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_owner_contact', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_availablity', models.CharField(choices=[('Available', 'Available'), ('Leased', 'Leased')], default='Available', max_length=100)),
                ('property_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property_owner.property')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='property_owner.property_unit')),
            ],
        ),
    ]
